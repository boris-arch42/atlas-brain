...
### Anisse est le proposeur de Sophia à Alec — pas l'inverse

Verbatim Anisse :
> *"J'ai vu un podcast sur YouTube de Sofia. Elle intervenait sur une chaîne que je regarde souvent qui s'appelle Master. Pour moi c'est les 2 meilleurs francophones e-commerçants. Et je me dis 'waouh, mais c'est qui cette meuf ?' Et donc je prends le podcast, je le pousse à Alex, je dis : 'C'est notre future directrice des opérations.'"*

→ **Implication politique forte** : Anisse porte la légitimité du choix Sophia. Si je veux poser des questions ou ajuster son scope, **Anisse est l'allié naturel à mobiliser**, pas Alec directement.

### Setup réel : audit + done with you, PAS un CDI

Verbatim Anisse :
> *"En gros elle nous explique qu'elle cherche pas un job parce que nous on voulait lui proposer un CDI à Dubaï. Elle nous dit 'bah moi je cherche pas un job, j'ai une boîte, j'ai des clients, j'ai un peu des cooties à droite à gauche et j'ai mes équipes.' Et par contre, je peux vous proposer quelque chose d'un peu différent : d'être un peu en immersion avec vous le premier mois."*

**Setup confirmé** :
- **PAS un CDI** (Alec voulait au départ, Sofia a refusé)
- **Audit en juin + done with you**
- **Immersion 1er mois** sur place
- 1er entretien fait à Marrakech le **1er jour des bombardements** (anecdote Anisse — référence aux missiles d'Iran sur Dubaï)

→ **Implication majeure** : Sophia n'est pas un "co-COO entrant" comme on le craignait. Elle est une **consultante senior en immersion ponctuelle**. Le risque d'écrasé par 3 COO + 1 GM disparait largement. Mon hypothèse HO16 ("si j'avance vite, sa venue peut être annulée") est partiellement résolue : il n'y a rien à annuler car ce n'est pas un poste, c'est une mission.

### Profil et expertise

Verbatim Anisse :
> *"Vraiment une ceinture noire dans le milieu des systèmes, des process, du management par les systèmes. Et elle est très connue dans le milieu e-com, c'est sa spécialité. Elle aide les boîtes e-com à passer de 3-4 M à 20 M. Et vraiment méga intelligente. Elle sait ce qu'elle fait, elle gère bien, bonne analyste, elle maîtrise bien les systèmes, les process. Elle maîtrise les fondamentaux."*

**Expertise structurante** :
- Systèmes et process
- **Management par les systèmes**
- E-commerce (sa spécialité)
- Boîtes 3-4M → 20M de CA
- **Multi-langues, remote, freelances** (même profil que Entrepreneurs.com sur l'organisation équipe)

### Vision Anisse de la complémentarité Boris↔Sophia

Verbatim Anisse — **à mémoriser** :
...
→ **Cadre de complémentarité explicite, validé par Anisse** :
- **Sophia** : audit + suggérer des templates/frameworks/systèmes (input ponctuel)
- **Boris** : exécuter, faire adopter, contrôler ces systèmes au quotidien
- **Fabrice** : se concentre sur **finance + DG / GM** (Anisse explicite : *"il faut lui enlever la partie opérationnelle, ça c'est trop de charge et il le vit, c'est pas viable"*)

## Rôle (prévu — reformulé 26/4)
- **Poste** : ~~Co-COO externe~~ → **Consultante senior en immersion + audit + done with you**
- **Arrivée prévue** : juin 2026 (audit) + immersion 1er mois
- **Manager** : [[Alec Henry]]
- **Mission annoncée par Alec** : ~~"améliorer plein de choses"~~ → plus précis : audit + frameworks de systèmes/process appliqués à Entrepreneurs.com

## ⚡ Implications stratégiques pour Boris

### Sophia n'est PAS une menace pour mon périmètre

Les craintes initiales ("3 COO", "qui fait quoi entre Sophia et moi") sont largement atténuées. Elle est un **input ponctuel**, je suis l'**exécuteur permanent**. Complémentarité naturelle.

### Sophia est une OPPORTUNITÉ pour mon mandat O2 (cartographie nœuds)

Elle apporte ce qui me manque le plus : **les frameworks et templates d'une boîte qui a réussi le passage catamaran → paquebot** (cf. métaphore Anisse HO31). Mon rôle sera de **traduire ses recommandations en exécution concrète avec les équipes**.

### Action S1-S2 : prendre contact AVANT son immersion

Idealement, je prends contact avec Sophia **avant son arrivée** (via Anisse comme connecteur naturel). Objectif :
1. Lui partager mon diagnostic des nœuds (ce que j'aurai cartographié à J+10 avec Alec/Fabrice)
2. Comprendre quels frameworks elle envisage d'apporter
3. Préparer une **immersion productive** plutôt qu'un audit à froid

C'est un win-win : elle entre informée, je gagne accès anticipé à ses templates, le "done with you" se transforme en "done together" dès le début.

### Cadre de complémentarité à proposer en séance trio (1er mai)

Si le sujet Sophia émerge spontanément, proposer ce cadre :
- **Sophia** : audit + frameworks éprouvés (paquebot e-commerce → paquebot Entrepreneurs.com)
- **Boris** : exécution + adoption + contrôle quotidien des systèmes proposés
- **Fabrice** : DG / GM finance + arbitrages stratégiques
- **Anisse** : team IA pour automatiser les systèmes proposés par Sophia

Ce cadre **est déjà validé par Anisse** spontanément (verbatim 26/4) — j'arrive en séance avec une proposition déjà endossée par 1 des 4 acteurs clés.

## Questions encore ouvertes

- **Niveau de rémunération / facturation Sophia** — toujours inconnu, mais probablement honoraires consultant (pas salaire)
- **Durée de la mission** — immersion 1 mois, mais quel suivi après ? Punctual ? Regular ?
- **A-t-elle déjà signé ?** — Anisse implique que la proposition est faite, mais pas confirmé si formellement contractualisée
- **Marge de manœuvre dans son audit** — va-t-elle suivre une méthodologie standard ou s'adapter à nos spécificités ?

## Scenarios révisés post-26/4

- ~~**(a) Complémentarité propre**~~ → **(a) Complémentarité explicite validée par Anisse** : audit/frameworks Sophia + exécution/adoption Boris
- ~~**(b) Substitution**~~ → **Écarté** : Sophia n'a pas demandé de poste
- ~~**(c) Rôle superflu**~~ → **Écarté** : ce n'est pas un poste à supprimer, c'est une mission ponctuelle
- **(d) NOUVEAU — Mission étendue** : si l'immersion fonctionne bien et que Boris+Sophia tournent en duo, le "done with you" peut s'étendre au-delà du 1er mois. À surveiller en juillet-août.

## Actions révisées

- **Mai (S1-S2)** : produire la cartographie nœuds + Plan trimestriel validé trio (KR2.1)
- **Mi-mai** : demander à Anisse de me mettre en contact avec Sophia (warm intro)
- **Fin mai** : 1er échange Sophia↔Boris pour partager le diagnostic + comprendre ses frameworks
- **Juin** : audit Sophia + immersion — j'agis comme **partenaire d'exécution**, pas comme audité
- **Fin juin** : revue conjointe Alec + Fabrice + Boris + Anisse + Sophia sur la suite à donner
- ~~**Avant fin juin** : clarification écrite scope Sophia vs Boris~~ → **largement résolu** : c'est une mission, pas un poste. Reste à clarifier la suite post-immersion.

## Notes liées
- [[2026-04-30 - Operating Partner chez Entrepreneurs.com]] (DR — H7 et critères 3 mois)
- [[2026-04-23 - Cadrage pré-prise de poste - Réponses Alec (CEO)]] (contexte d'annonce)
- [[Anisse Rbibe]] (proposeur de Sophia, allié naturel pour la connecter)
- [[Diag - Hypothèses que j'ai sur la boîte (à vérifier)]] (HO16 — largement résolu, HO31 métaphore catamaran/paquebot — Sophia est la réponse à ce trou de compétence)
- [[Fabrice Jaeger]] (Sophia confirme indirectement le repositionnement Fabrice GM finance)
