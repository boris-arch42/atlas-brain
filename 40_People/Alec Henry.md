---
type: person
role: "CEO Entrepreneurs.com, Co-fondateur Riven Agency"
team: "Entrepreneurs.com, Riven Agency"
manager: 
reports: 
started: 
status: active
...
tags: [ceo, fondateur, entrepreneurs-com, riven-agency, dual-role]
---
...
### Riven Agency
- **Poste** : Co-fondateur
- **Associés** : [[Boris Arduy]], Tomas _(nom de famille à compléter)_

---

## Ses attentes formelles sur mon rôle (cadrage 2026-04-23)

Source : [[2026-04-23 - Cadrage pré-prise de poste - Réponses Alec (CEO)]], Q1.

Alec a formulé **5 axes** (il avait demandé "une seule chose" — glissement à surveiller) :

1. **Libérer Fabrice** des micro-tâches. Par systèmes, process, recrutements, pensée — **pas en reprenant les tâches opérationnelles moi-même**.
2. **Mieux piloter la boîte** : less is more — moins d'outils, moins de systèmes, moins de people, moins de micro-management. Plus de cadre et de maîtrise.
3. **Préparer (ou rendre inutile) l'arrivée de Sophia** en juillet.
4. **Cadrer la stratégie produit / tech / data / IA** : internalisation tech 3-6 mois, stack solide, pas de dette.
5. **Automatisation RH / culture / ops**.

## Ses dérapages rouges (red flags à éviter)

Source : Q2 du cadrage.

1. **Ne pas intervenir sur pôles opérationnels** (marketing, communication, event, closing, finance).
2. **Ne pas être pris pour exécutant / data ops** — même si je pourrais mieux faire, ce n'est pas mon rôle.
3. **Ne pas créer en parallèle des autres pôles** — compounder, pas doubler.
4. **Ne pas créer "une entreprise dans l'entreprise"** avec mes équipes, process, machins. Posture attendue : "6 mousquetaires" — combler les trous, pas ajouter des couches.

Mantra Alec : *"Structurer, simplifier, limiter les coûts au maximum. Less is more."*
...
- Le travail de structuration fait en amont se fait détricoter
- Les équipes perdent confiance dans la stabilité des décisions
- Aucun pilotage durable possible sans garde-fou

**Pourquoi c'est le risque n°1 pour moi** :
- La valeur que j'apporte (structuration, systèmes, process) est précisément le type de travail qui peut être défait par un revirement impulsif
- Si je ne mets pas de garde-fou dès semaine 1, je vais structurer des choses qui se feront détricoter et je perdrai 2-3 mois sans m'en apercevoir
- L'impulsivité d'Alec est **la cause racine** du "manque de pilotage" qu'il me demande lui-même de résoudre. Pas de pilotage sans contenir ça.

**Mitigations à mettre en place — S1** :

- **Règle écrite du revirement** : tout retour en arrière sur une décision déjà actée passe par un échange écrit (mail, Slack, DR mis à jour) avant exécution. À négocier explicitement avec Alec en semaine 1 comme garde-fou mutuel.
- **Documentation systématique** : pour chaque décision structurante que je porte avec Alec, je lui envoie un récap écrit dans les 24h. Si revirement ultérieur, on l'ancre sur le récap, pas sur une reconstruction de mémoire.
- **Signal de cadrage** : à la 1re fois où je sens un revirement arriver, je ne m'oppose pas frontalement — je demande "on peut prendre 30 min pour refaire le tour avant que tu actionnes ?". Le temps gagné est la mitigation.

**Test de mitigation (HO15 du [[Diag - Hypothèses que j'ai sur la boîte (à vérifier)]])** :
- Le pattern se manifestera-t-il au moins 1 fois pendant les 6 premières semaines sur une décision que j'aurai structurée ?
- À J+45 : mitigations tenues ? Alec a-t-il accepté le garde-fou écrit ?
- Si la mitigation ne prend pas en 6-8 semaines : H8 du DR invalidée, rôle structurellement non-tenable.

### 2. Glissement de scope dans les demandes

Observé au cadrage : demande "une seule chose" → livre 5 axes. Pattern probable à re-voir sur chaque brief opérationnel.

**Mitigation** : reformuler systématiquement la demande à l'écrit avant exécution, avec distinction "priorité 1 / bonus". Faire valider avant d'agir.

### 3. Double-lien avec moi (CEO / associé Riven)

Déjà documenté. Règles en place :
- Canaux de communication séparés (un canal par entité)
- Calls mono-projet
- Nommer la casquette en cas d'ambiguïté

**TODO S1** : formaliser avec Alec une règle de récusation sur les décisions RH Entrepreneurs.com qui toucheraient un profil proche de Riven (ou inversement).
...
- Vision stratégique et lecture du marché
- Décision rapide sous incertitude
- Capacité à attirer / convaincre des profils externes
