...
> Note générée par Jarvis (`atlas-sync`) — **ne pas éditer**, toute modification sera écrasée. Dernière màj : 26/09/2026 07:26.
...
## 🚨 Blocages ouverts
- **P1** « PAS DE DEAD LINE SUR livraison » (Espace client  plateforme refondu) — Bloqué · porteur — · depuis 44 j
...
- creation leaderboard (`cockpit_id: cmsqsyicm0017l104j3xwjyx3`)
- Espace client  plateforme refondu (`cockpit_id: cmsqsomzw001bl204ld6w9knz`)
- Succes score clients (`cockpit_id: cmsqshttq000vl404naul9bl5`)
- Déployer un pôle CSM avec personne dédié (`cockpit_id: cmsiogwf90001jp04hzewtf20`)

[Ouvrir le cockpit](https://ops-cockpit-rho.vercel.app) · Voir aussi [[🗼 Tour de contrôle - Projets en cours]]
